 ...
 */
final class Version20260922084414 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tbl_image (id INT AUTO_INCREMENT NOT NULL, path VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
        $this->addSql('CREATE TABLE image_credit (image_id INT NOT NULL, credit_id INT NOT NULL, INDEX IDX_B3DC30363DA5256D (image_id), INDEX IDX_B3DC3036CE062FF9 (credit_id), PRIMARY KEY (image_id, credit_id)) DEFAULT CHARACTER SET utf8');
